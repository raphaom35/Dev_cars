...
namespace DevCars.API.Presistence.Migrations
{
    ...
    [Migration("20210405192310_Initialmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevCars.API.Entities.Custumer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevCars.API.Entities.Order", b =>
                {
                    ...
                    b.HasOne("DevCars.API.Entities.Custumer", "Custumer")
                        .WithMany("Orders")
                        .HasForeignKey("IdCurtumer")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
